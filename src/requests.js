...
export const GITHUB_BASE_URL = "https://github.com/Agni-Saha";
const GITHUB_ASSETS_BASE_URL = "https://cdn.jsdelivr.net/gh/Agni-Saha/assets-cdn";
...
export const GITHUB_AVATAR_URL = `${GITHUB_ASSETS_BASE_URL}/profile.jpg`;
